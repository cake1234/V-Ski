 ...
 render() {
    ...
    return (
      <View style={styles.container}> 
        ...
        <Text style={styles.description}>Choisis une ligne:</Text>
        <PickerIOS
        ...
        <Text style={styles.description}>Choisis une station du RER  {make.ligne}:</Text>
        <PickerIOS
        itemStyle={{fontSize: 15, color: 'white', fontWeight: '500'}}
          ...
          {LIGNE_STATION[this.state.ligneMake].station.map((stationName, stationIndex) => (
           ...
           <Text style={styles.description}>Vous avez sélectionné: {selectionString} à {this.state.date.getHours()}h{this.state.date.getMinutes()}min</Text>
           
           <TouchableHighlight style={styles.button}
               onPress={() => this.addLigne(make.station[this.state.stationIndex])}>
    <Text style={styles.buttonText}>Go</Text>
  </TouchableHighlight>
    <Text style={styles.description}>Choisis l'horaire:</Text>
